# complexFunctions
This is a library for functions of complex number written based on foam-extend-4.1.


## Installation
It is working on foam-extend-4.1.
```bash
git clone https://github.com/EhsanGLB/complexFunctions.git
cd complexFunctions/complexFunctions
wmake libso
```


## Activation
Add directory of lnInclude (the compiled headers file) and libcomplexFunctions to solver/Make/option
